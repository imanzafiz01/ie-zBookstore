  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php" style="padding: 1px;"><p  style="width: 147px;margin: 10px;">IE-Z BOOKSTORE<p></a>
        </div>
                            ...
                            <div class="modal-body">
                                          <form class="form" role="form" method="post" action="index.php" accept-charset="UTF-8">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" name="login_username" class="form-control" placeholder="Username or Email" required>
                                              </div>
                                              <div class="form-group">
                      ...
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                                        <form class="form" role="form" method="post" action="index.php" accept-charset="UTF-8">
                                            <div class="form-group">
                                                <label class="sr-only" for="username">Username</label>
                                                <input type="text" name="register_username" class="form-control" placeholder="Username or Email" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="sr-only" for="password">Password</label>
...
?>
  ...
  <div id="top" >
      <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
          <div>
              <form role="search" method="POST" action="Result.php">
                  <input type="text" class="form-control" name="keyword" style="width:80%;margin:20px 10% 20px 10%;" placeholder="Search for a Book or Author">
              </form>
          </div>
      </div>
    ...
    if(isset($_GET['value']))
        {
            if($_POST['sort']=="book_price")
                {   $query = "SELECT * FROM products ORDER BY book_price";
        ...
        if($_POST['sort']=="priceh")
                {   $query = "SELECT * FROM products ORDER BY book_price DESC";
                    $result = mysqli_query ($con,$query)or die(mysqli_error($con));
                }
    } 
    else   
    ...
    echo '<div class="container-fluid" id="books">
        ...
        {   
            ...
            {
            $path="img/books/" .$row['book_isbn'].".jpg";
            $description="description.php?ID=".$row["book_isbn"];
            if($i%4==0)
            echo '<div class="row">';
            echo'
               <a href="'.$description.'">
...
<div class="container">
  ...
  <button type="button" id="query_button" class="btn btn-lg" data-toggle="modal" data-target="#query">FAQ</button>
  <!-- Modal -->
          ...
          <div class="modal-body">           
                    <form method="post" action="query.php" class="form" role="form">
                        ...
                        <div class="form-group">
                             ...
                             <textarea class="form-control" rows="5" cols="30" name="message" placeholder="Your Question or Feedback" required></textarea>
                        </div>
                        <div class="form-group">
