	...
	if(isset($_SESSION['user']))
	    {   
	            ...
	            {   
              	...
              	$query="SELECT book_isbn, book_tittle, book_author, Quantity, book_price FROM cart INNER JOIN products ON cart.Product=products.book_isbn 
	        ...
	        $result=mysqli_query($con,$query); 
                ...
                {    $i=1;
                     ...
                     {       $path = "img/books/".$row['book_isbn'].".jpg";
                             $Stotal = $row['Quantity'] * $row['book_price'];
                             if($i % 2 == 1)  $offset= 1;
                             if($i % 2 == 0)  $offset= 2;                                                
                             if($j%2==0)
                                 echo '<div class="row">'; 
                                      ...
                                      <div class="panel col-xs-12 col-sm-4 col-sm-offset-'.$offset.' col-md-4 col-md-offset-'.$offset.' col-lg-4 col-lg-offset-'.$offset.' text-center" style="color:#D67B22;font-weight:800;">
                                          ...
                                          <div class="panel-body">
			                                                <img class="image-responsive block-center" src="'.$path.'" style="height :100px;"> <br>
           							                                               Title : '.$row['book_tittle'].'  <br> 
                                                                        Code : '.$row['book_isbn'].'     <br>        	 
                                                      									Author : '.$row['book_author'].' <br>
                                                      									Quantity : '.$row['Quantity'].' <br>
                                                      									Price : '.$row['book_price'].' <br>
                                                      									Sub Total : '.$Stotal.' <br>
                                                                       <a href="cart.php?remove='.$row['book_isbn'].'" class="btn btn-sm" 
