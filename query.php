...
{
    $recipient="imanzafiz01@gmail.com";
    $subject="Answer from bookstore";
    $sender=$_POST["sender"];
    ...
    $resSub = "Confirmation of receiving your feedback";
    $resBody= "Dear ". $sender ."\n\nThanks for reaching us.\nThis is to inform you that we have received your feedback. We will get back to you asap.";
